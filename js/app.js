...
// A. The basics
// Write a loop that will print out all the numbers from 0 to 
//10, inclusive.
// for (let i = 0; i < 11; i++) {
//     console.log(i);
// }

// // Write a loop that will print out all the numbers from 10 up 
...
// B. Get even
// Print out the even numbers that are within the range of 
//1 - 100.
for (let i = 1; i < 101; i++) {
    if ([i] % 2 === 0)
    console.log(i);
